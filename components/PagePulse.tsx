  ...
  return (
    <section className="flex h-full w-full items-center justify-center bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 px-16">
      <div className="flex max-w-5xl flex-col items-center text-center">
        <p className="mb-6 text-2xl font-bold tracking-[0.4em] text-emerald-400 uppercase">
          Page 1 Canvas
        </p>
        <h2 className="text-8xl font-black tracking-tight text-white drop-shadow-[0_2px_24px_rgba(16,185,129,0.25)]">
          PULSE
        </h2>
        <p className="mt-8 max-w-3xl text-3xl font-semibold leading-snug text-slate-200">
          Campus heartbeat — peer progress, active seats, and who is grinding
          right now.
        </p>
